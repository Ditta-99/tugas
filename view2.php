...
$data_nama = cekFileJson();
$total_data = count($data_nama);
...
if ($total_data == 0) {
    ...
    for ($i = 0; $i < $total_data; $i++) 
    {
            ...
            echo "<td>" . htmlspecialchars($nama['nama']) . "</td>";

            // Menampilkan nama produk
            echo "<td>" . htmlspecialchars($nama['kursus']) . "</td>";
            echo "</tr>";

    }
    echo "</table>";
    echo "<center><button onclick=\"window.location.href='frm2.html'\">+</button></center>";
