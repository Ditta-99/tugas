...
if ($total_data == 0) {
    ...
    {
            $jabatan = $data_jabatan[$i];

            // Menampilkan No
            echo "<tr><td>" .($i + 1) . "</td>";

            // Menampilkan kode produk 
            echo "<td>" . htmlspecialchars($jabatan['nama']) . "</td>";
    ...
    echo "</table>";
    echo "<center><button onclick=\"window.location.href='frm4.html'\">+</button></center>";
