...
$data_merek = cekFileJson();
$total_data = count($data_merek);

if ($total_data == 0) {
    echo "<p>Belum ada data produk yang disimpan </p>";

} else {
    echo "<table border= '1'>
    <h3>DAFTAR MEREK KENDARAAN</h3>
    <tr>
            <th>NO</th>
    ...
    for ($i = 0; $i < $total_data; $i++) 
    {
            ...
            echo "<td>" . htmlspecialchars($merek['merek']) . "</td>";

            // Menampilkan nama produk
            echo "<td>" . htmlspecialchars($merek['tahun']) . "</td>";
            echo "</tr>";

    }
    echo "</table>";
    echo "<center><button onclick=\"window.location.href='frm3.html'\">+</button></center>";
